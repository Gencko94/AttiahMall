...
import ksa from '../assets/flags/saudi-arabia.svg';
...
export default function DataContextProvider({ children }) {
  const [deliveryCountry, setDeliveryCountry] = React.useState('ksa');
  const [selectedStore, setSelectedStore] = React.useState('ksa');
  ...
  const stores = ['usa', 'uk', 'jp', 'korea', 'kuwait', 'qatar', 'uae', 'ksa'];
