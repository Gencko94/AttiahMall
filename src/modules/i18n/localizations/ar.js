export const ar = {
  ...
  'register-on-attiah': 'اشترك في AttiahMall',
  ...
  'multiple-items': 'قطع',
  'cart-tos':
    'إن سعر وتوافر العناصر على attiah-mall.com عرضة للتغيير. تعتبر عربة التسوق مكانًا مؤقتًا لتخزين قائمة بالعناصر الخاصة بك وتعكس أحدث سعر لكل عنصر.',
  ...
  'checkout-modal-tos':
    'يساعدنا امتلاكك لحساب على attiah-mall.com على تقديم افضل الخدمات لك ولعملائنا الآخرين .',
